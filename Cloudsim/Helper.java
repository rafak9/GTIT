...
public final class Helper {
    ...
    public static List<Vm> createVmList(DatacenterBroker broker, int vmsNumber) {
        ...
        for (int i = 0; i < vmsNumber; i++) {
            int vmType = 0;// i / (int) Math.ceil((double) vmsNumber / Constants.VM_TYPES);
    ...
    public static List<PowerHost> createHostList(int hostsNumber) {
        ...
        for (int i = 0; i < hostsNumber; i++) {
            int hostType = 0;//i % Constants.HOST_TYPES;
    ...
    public Datacenter createDatacenter(
        ...
        dc.getCharacteristics()
                ...
                .setCostPerMem(0.05) //0.05
                .setCostPerStorage(0.001) //0.001
                .setCostPerBw(0.0);
