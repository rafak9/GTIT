...
public class PowerExample_1 {
    ...
    private static final int CLOUDLET_LENGTH = 9000000;
    /**
...
//        final PowerDatacenter dc = new PowerDatacenter(simulation, hostList, new VmAllocationPolicySimple() );
    ...
    private PowerHostUtilizationHistory createPowerHost() {
      ...
      //List of Host's CPUs (Processing Elements, PEs)
        ...
        for (int i = 0; i < HOST_PES; i++) {
            peList.add(  new PeSimple(2660, new  PeProvisionerSimple()));
        }
        
        
        final PowerModel powerModel = new PowerModelSpecPowerHpProLiantMl110G5Xeon3075();
    ...
    private List<PowerVm> createPowerVms() {
        ...
        for (int i = 0; i < VMS; i++) {
            ...
            PowerVm vm = new PowerVm(i, 2660, VM_PES);
            vm.setRam(4096).setBw(100).setSize(10000)
...
/*
            Cloudlet cloudlet =
                new CloudletSimple(0, CLOUDLET_LENGTH, CLOUDLET_PES)
                    .setFileSize(5000)
                    .setOutputSize(30000)
 ...
 */
        ...
        for (int i = 0; i < CLOUDLETS; i++) {
           ...
           final long length =  CLOUDLET_LENGTH;
