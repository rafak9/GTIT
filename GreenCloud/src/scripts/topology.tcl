...
#top(NAccess) * top(NRackHosts) dah o numero de servidores
...
switch $sim(dc_type) {
  ...
  "three-tier debug" {
    ...
    set top(NAggr)		[expr 2*$top(NCore)]	;# Number of Switches in AGGREGATION network 
    set top(NAccess)		1			;# Number switches in ACCESS network per pod
    set top(NRackHosts)		1000		;# Number of Hosts on a rack
  }
